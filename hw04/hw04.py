...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_end_torque, right_end_torque = total_weight(left_end) * length(left(m)), total_weight(right_end) * length(right(m))
        return left_end_torque == right_end_torque and balanced(left_end) and balanced(right_end)
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == 'loki':
        ...
        branch = [replace_loki_at_leaf(b,lokis_replacement) for b in branches(t)]
